          ...
          <div class="card mb-3" style="border-radius: .5rem;">
            <div class="row g-0">
              <div class="col-md-4 gradient-custom text-center text-white"
                ...
                <img src="../img/usuario.png" alt="Avatar" class="img-fluid my-5" style="width: 80px;" />
                ...
                <div class="card-body p-4">
                  ...
                  <div class="row pt-1">
                    <div class="col-6 mb-3">
                      <h6>Usuario:</h6>
                      <p class="text-muted"><?php echo $usuario; ?></p>
                    </div>
                    <div class="col-6 mb-3">
                      <h6>Telefono:</h6>
                  ...
                  <div class="row pt-1">
                    <div class="col-6 mb-3">
                      <a href="cerrar.php" class="btn btn-danger btn-lg">Cerrar Sesion</a>
                    </div>
                  </div>
